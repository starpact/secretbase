...

{
  dconf.settings = {
    ...
    "org/gnome/desktop/interface" = {
      font-name = "FantasqueSansM Nerd Font 12";
      document-font-name = "FantasqueSansM Nerd Font 12";
      monospace-font-name = "FantasqueSansM Nerd Font 12";
    ...
    "org/gnome/shell/keybindings" = {
      ...
      switch-to-application-6 = [ "<Super>T" ];
      toggle-message-tray = [ ];
